---
description: Hướng dẫn sử dụng bản thường
layout:
  width: wide
  title:
    visible: true
...
<figure><img src="../.gitbook/assets/xuat-ebook.png" alt=""><figcaption></figcaption></figure>

Thay đổi kiểu hiển thị truyện

{% tabs %}
{% tab title="Trong kệ sách" %}
<figure><img src="../.gitbook/assets/sap-xep-2.png" alt=""><figcaption></figcaption></figure>
{% endtab %}

{% tab title="Trong khám phá" %}
<figure><img src="../.gitbook/assets/sap-xep-1.png" alt=""><figcaption></figcaption></figure>
{% endtab %}
{% endtabs %}
